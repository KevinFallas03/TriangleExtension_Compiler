...
//    }
  ...
  private void writeLineXML(String line) {
    try {
      ...
      System.err.println("Error while writing file XML for print the AST");
      e.printStackTrace();
    }
  }
  ...
  private String transformOperator(String operator) {
    ...
    public Object visitVarDeclarationBecomes(VarDeclarationBecomes ast, Object o) {
        writeLineXML("<VarDeclarationBecomes>");
        ast.E.visit(this, null);
        ast.I.visit(this, null);
        writeLineXML("</VarDeclarationBecomes>");
        return null;    
    ...
    public Object visitSeqPackageDeclaration(SeqPackageDeclaration ast, Object o) {
        writeLineXML("<SeqPackageDeclaration>");
        ast.d1AST.visit(this, null);
        ast.d2AST.visit(this, null);
        writeLineXML("</SeqPackageDeclaration>");
        return null;    
